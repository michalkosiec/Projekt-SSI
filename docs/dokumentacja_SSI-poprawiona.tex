...
\begin{document}
	...
	\begin{itemize}
		...
		\item \texttt{decision\_tree.py} -- drzewo decyzyjne z kryterium Gini.
...
Model osiągnął skuteczność 54\%.
    ...
    \begin{figure}[htbp]
    	\centering
    	\includegraphics[width=0.8\textwidth]{img/porownanie.png}
    	\caption{Porównanie dokładności algorytmów.}
