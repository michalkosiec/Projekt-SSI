...
epsilons = [max(1e-4 * var, 1e-9) for var in global_variances]
	...
	\subsubsection*{KNN}
	Poniższa tabela przedstawia macierz pomyłek dla wytrenowanego modelu \texttt{KNN}.
	
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=1.0\textwidth]{img/main\_menu.png}
	...
	\begin{figure}[htbp]
		...
		\label{fig:wyniki_drzewo_decyzyjne}
	\end{figure}
